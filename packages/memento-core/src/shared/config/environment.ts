...
const ENV_DEFAULTS: Record<string, string> = {
  ...
  SEARCH_MAX_LIMIT: '50',
  // #1095 검색 기각 게이트 — 기본 off 라 켜기 전까지 제품 동작 불변
  ...
  SEARCH_REJECTION_GATE_ON_ERROR: 'open',
  ...
  MEMENTO_AUTO_SET_ANCHOR_DEFAULT: 'true',
  // WAL 체크포인트 스케줄러 설정
