...
import type { IFeedbackRepository } from '../../../domains/memory/repositories/feedback-repository.interface.js';
...
export class FeedbackRepositorySQLite implements IFeedbackRepository {
