...
-- Meta memory statistics (migration 011: 011-meta-memory-stats-schema.sql)
-- recall 통계: memory_item 삭제 시 CASCADE
...
-- Append-only tamper-evident audit chain (migrations 040 and 042)
CREATE TABLE IF NOT EXISTS audit_log (
  ...
  owner_id TEXT,
  agent_id TEXT,
  transport TEXT NOT NULL CHECK (transport IN ('mcp_stdio', 'mcp_http', 'mcp_ws', 'rest', 'http_admin')),
