...
import { OnDemandDatabaseOptimizer } from '../on-demand-database-optimizer.js';
import type { DatabaseStats, IndexRecommendation, QueryAnalysis } from '../on-demand-database-optimizer.js';
import Database from 'better-sqlite3';
import { setupTestDatabase, cleanupTestDatabase } from '../../../test/helpers/test-database.js';

describe('DatabaseOptimizer', () => {
  let db: Database.Database;
  let optimizer: OnDemandDatabaseOptimizer;

  beforeEach(async () => {
    db = await setupTestDatabase();
    optimizer = new OnDemandDatabaseOptimizer(db);
  });
