...
import { getBatchScheduler, BatchScheduler } from '@memento/corescheduler/batch-scheduler.js';
import { getPerformanceMonitor } from '@memento/core/domains/monitoring/services/performance-monitor.js';
import { ForgettingPolicyService } from '@memento/coreforgetting/services/forgetting-policy-service.js';
import Database from 'better-sqlite3';
import { DatabaseUtils } from '@memento/core/shared/utils/database.js';

// Mock dependencies
import { vi } from 'vitest';
vi.mock('@memento/coreperformance-monitor.js');
vi.mock('@memento/coreforgetting-policy-service.js');
