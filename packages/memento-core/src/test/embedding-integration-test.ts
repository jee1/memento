...
import { EmbeddingProviderFactory } from '@memento/core/domains/embedding/providers/embedding-provider-factory.js';
import type { EmbeddingData } from '@memento/core/shared/types/embedding.types.js';
...
describe('임베딩 서비스 통합 테스트', () => {
  ...
  describe('제공자별 특성 검증', () => {
    ...
    it('TF-IDF 제공자 특성', async () => {
      ...
      // TF-IDF 서비스를 직접 사용
      const { LightweightEmbeddingService } = await import('@memento/core/domains/embedding/services/lightweight-embedding-service.js');
