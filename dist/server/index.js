...
let performanceMonitoringIntegration;
...
async function initializeServer() {
    try {
        ...
        performanceMonitoringIntegration = new PerformanceMonitoringIntegration(db, performanceAlertService, {
        ...
        server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                if (errorLoggingService) {
                    errorLoggingService.logError(error instanceof Error ? error : new Error(String(error)), ErrorSeverity.HIGH, ErrorCategory.UNKNOWN, {
