...
export async function executeErrorStats(args, context) {
    ...
    try {
        ...
        const searchFilters = {};
        if (severity)
            searchFilters.severity = severity;
        if (category)
            searchFilters.category = category;
        if (includeResolved !== undefined)
            searchFilters.resolved = includeResolved;
...
//# sourceMappingURL=error-stats.js.map