...
export class PerformanceBenchmark {
    ...
    async benchmarkMemoryOperations() {
        ...
        const result = this.calculateBenchmarkResult('Memory Operations', iterations, times, beforeMemory, afterMemory, errors);
    ...
    async benchmarkSearchOperations() {
        ...
        const afterMemory = process.memoryUsage();
        const result = this.calculateBenchmarkResult('Search Operations', iterations, times, beforeMemory, afterMemory, errors);
        this.results.push(result);
        this.printResult(result);
    }
    /**
    ...
    async benchmarkCacheOperations() {
        ...
        const afterMemory = process.memoryUsage();
        const result = this.calculateBenchmarkResult('Cache Operations', iterations, times, beforeMemory, afterMemory, errors);
        this.results.push(result);
        this.printResult(result);
    }
    /**
    ...
    async benchmarkAsyncOperations() {
        ...
        const afterMemory = process.memoryUsage();
        const result = this.calculateBenchmarkResult('Async Operations', iterations, times, beforeMemory, afterMemory, errors);
        this.results.push(result);
        this.printResult(result);
    }
    /**
    ...
    async benchmarkConcurrentOperations() {
        ...
        const afterMemory = process.memoryUsage();
        const result = this.calculateBenchmarkResult('Concurrent Operations', concurrentUsers * operationsPerUser, times, beforeMemory, afterMemory, errors, totalTime);
        this.results.push(result);
        this.printResult(result);
    }
    /**
     * 작업 완료 대기
     */
    async waitForTaskCompletion(taskId, maxWait = 10000) {
     ...
     */
    async retryOperation(operation, maxRetries = 3, baseDelay = 100) {
        let lastError;
     ...
     * 벤치마크 결과 계산
     */
    calculateBenchmarkResult(testName, iterations, times, beforeMemory, afterMemory, errors, totalTime) {
