...
For the current full schema and design (tables, naming rules, migration history), see [Database Design](../../architecture/en/database-design.md). The following describes the **M1 baseline** only.
