...
**대상**: [guides/ko/sdd-workflow.md](guides/ko/sdd-workflow.md)에서 정한 `docs/plans/ko/YYYY-MM-DD-기능명/` 내 design.md, spec.md, implementation-plan.md.
...
| 경로 | 보유 문서 | 비고 |
|------|-----------|------|
| **docs/design/** | memento-cli-for-ai-review.md, recall-context-saving-ideas.md | 설계·리뷰 초안 |
| **docs/brainstorms/** | 2026-03-04-monorepo-memento-core-brainstorm.md | 모노레포 설계 논의 |
| **docs/specs/ko/** | 2026-03-11-memento-cli-for-ai-spec.md | SPEC은 현재 이 기능만 존재 |
| **docs/plans/ko/** | 아래 표 참조 | 플랫 파일 + 2026-03-11-memento-cli-for-ai/ (Memory Bank 3종) |
| **docs/issues/** | 2026-03-13-memento-cli-skills-for-llm.md | 미착수 기능 제안 |
...
| 이슈/문서 | 방안 |
|-----------|------|
| docs/issues/2026-03-13-memento-cli-skills-for-llm.md (#112) | 구현 착수 시 `plans/ko/2026-03-13-memento-cli-skills-for-llm/` 생성. 이슈 내용을 바탕으로 design.md → spec.md → implementation-plan.md 순으로 작성. (가이드 §5.1) |
