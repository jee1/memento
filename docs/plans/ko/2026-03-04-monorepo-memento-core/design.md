...
→ **구현 계획**: [docs/plans/ko/2026-03-04-monorepo-memento-core-implementation-plan.md](../plans/ko/2026-03-04-monorepo-memento-core-implementation-plan.md) — Phase 1(워크스페이스)부터 순서대로 진행.
