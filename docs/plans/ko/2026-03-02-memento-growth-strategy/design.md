...
| **정확성 — 검색 품질** | consolidation 점수 반영·랭킹 일관성 | `npm run benchmark:consolidation-quality`, baseline 비교 [consolidation-quality-testing.md](../../testing/ko/consolidation-quality-testing.md) |
| **정확성 — recall 활용도** (선택) | recall 결과가 실제 답변/행동에 반영되는지 | MVP 검증 지표로 정의 가능 [memento-based-personal-assistant-mvp-research.md](../../research/ko/memento-based-personal-assistant-mvp-research.md) |
...
- [memento-based-personal-assistant-mvp-research.md](../../research/ko/memento-based-personal-assistant-mvp-research.md) — MVP 범위·검증 지표
